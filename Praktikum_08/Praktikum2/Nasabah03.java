...
public class Nasabah03  {
    ...
    Nasabah03 (String norek, String nama, String alamat, int umur, double saldo) {
        this.norek = norek;
        this.nama = nama;
        this.alamat = alamat;
        this.umur = umur;
        ...
        if(!IsEmpty()) {
            System.out.println("Atrian Posisi belakang : " + data[rear].nama);
        } else {
